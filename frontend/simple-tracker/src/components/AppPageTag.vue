      ...
      <div class="p-4 flex flex-col">
        ...
        <div class="mb-4">
          ...
          <div class="flex gap-2 items-center">
            <input
              type="color"
              v-model="tagColor"
              class="p-1 rounded-md standout grow font-medium focus:outline-none focus:border-none w-full h-12"
            />
            <CubeIcon
        ...
        <div v-if="!isNew" class="mb-4">
          ...
          <input
            type="text"
            v-model="tagDotText"
            class="w-full p-2 rounded-md bg-background caret-primary standout font-medium text-lg focus:outline-none"
