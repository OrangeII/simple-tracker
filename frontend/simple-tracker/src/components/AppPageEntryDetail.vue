    ...
    <template #main>
      <div class="p-4 flex flex-col gap-4">
          ...
          <div>
            ...
            <div class="flex justify-between items-center gap-4">
              <input
                ...
                class="p-2 rounded-md grainy dark:bg-blend-overlay grow font-medium text-lg focus:outline-none focus:border-none"
              />
              <input
                required="true"
                type="time"
        ...
        <div>
          ...
          <textarea
            v-model="entryNotes"
            class="w-full p-2 rounded-md grainy dark:bg-blend-overlay font-medium text-lg focus:outline-none focus:border-none"
            rows="3"
