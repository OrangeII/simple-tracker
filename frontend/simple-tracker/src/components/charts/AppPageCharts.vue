  ...
  <div class="p-4 h-full flex flex-col">
    ...
    <div v-else>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div
          class="cursor-pointer h-96 grainy bg-background dark:bg-blend-overlay rounded-sm border-1 border-text/10 hover:border-primary/40 p-4 flex flex-col gap-4"
