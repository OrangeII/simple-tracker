<template>
  <div class="relative">
    <input
      type="text"
      class="w-full p-2 dark:bg-blend-overlay grainy font-medium text-lg focus:outline-none"
      :class="[
        showDropdown
    ...
    >
      <div
        class="max-h-48 overflow-y-auto grainy dark:bg-blend-overlay flex flex-wrap gap-y-2 py-2 px-1"
        :class="[
